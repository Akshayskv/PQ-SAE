...
/* ADDITION */
#define RSN_AUTH_KEY_MGMT_PQ_SAE RSN_SELECTOR(0x00, 0x0f, 0xac, 50) /* experimental */
/* END */
...
#define RSN_AUTH_KEY_MGMT_PQ_SAE RSN_SELECTOR(0x00, 0x0f, 0xac, 50)  /* experimental, not IEEE-registered */
